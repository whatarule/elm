...
var _user$project$Models$initialModel = function (route) {
	return {players: _krisajenkins$remotedata$RemoteData$Loading, route: route, changes: 0};
};
var _user$project$Models$Model = F3(
	function (a, b, c) {
		return {players: a, route: b, changes: c};
	});
...
var _user$project$Routing$playerPath = function (id) {
	return A2(
		...
		_user$project$Routing$playersPath,
...
var _user$project$Main$init = function (location) {
	var currnetRoute = _user$project$Routing$parseLocation(location);
	return {
		ctor: '_Tuple2',
		_0: _user$project$Models$initialModel(currnetRoute),
